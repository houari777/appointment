...
List<dynamic> schedules=[
  ...
  Widget build(BuildContext context) {
    ...
    List<dynamic>filtredSchedules=schedules.where((var schedule) {
    ...
    _alignment=Alignment.center;
          ...
          Expanded(child: ListView.builder(
              ...
              itemBuilder: (context,index){
                var _schedule=filtredSchedules[index];
                bool isLastElement=filtredSchedules.length +1==index;
                return Card(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: const <Widget>[
          ...
          SizedBox(width: 5,),
          Flexible(child: Text(
            '2:00 PM', style: TextStyle(color: Config.primaryColor),
          ))
